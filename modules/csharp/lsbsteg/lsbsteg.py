...
class lsbsteg(Module):
    ...
    description = """LSB Steganography in memory download obfuscation module for C#, returns a base64, base16 and binary version of the provided payload with a C# decryption function and image need to fix this string"""
