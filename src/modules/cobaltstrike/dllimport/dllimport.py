...
class dllimport(Module):
    ...
    description = """Module that accepts a string argument to find a Cobalt Strike BOF DLLImport statement. String argument should be API function name
    """
    ...
    def run(self):
        ...
        yaml_config = load_config(os.path.join("modules", "cobaltstrike", "dllimport", "imports.yaml"))
